...
{/* _____________-CARD_____________- */}
           <TouchableOpacity style={[styles.card,{width:this.state.WIDTH},{shadowOffset:{  width: 30,  height: 30,  },shadowColor:'black',shadowOpacity:1},{borderColor:"#fff3e0",}]} onPress={()=>this.props.navigation.dispatch(DrawerActions.openDrawer())}>
                   ...
                   <View style={{borderBottomColor:"#eee",borderBottomWidth:1,paddingBottom:5}}> 
                       ...
                       <Text>Status : </Text>
                       <Text style={{color:'#ff9800'}}> Pending</Text>
                       </View>
                       <Text>Applied  : 10 days ago</Text>
                   ...
                   <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between',alignItems:'space-between',marginTop:10}}>
                       ...
                       <Text style={{fontSize:16,fontWeight:'bold',color:"red"}}>Cancel</Text>
                       </TouchableOpacity>
           ...
           <TouchableOpacity style={[styles.card,{width:this.state.WIDTH},{shadowOffset:{  width: 30,  height: 30,  },shadowColor:'black',shadowOpacity:1},{borderColor:"#fff3e0",}]} onPress={()=>this.props.navigation.dispatch(DrawerActions.openDrawer())}>
                   ...
                   <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between',alignItems:'space-between',marginTop:10}}>
                       ...
                       <TouchableOpacity style={{padding:5}} onPress={()=>this.props.navigation.navigate('PostJob')}>
                       <Text style={{fontSize:16,fontWeight:'bold',color:"red"}}>Cancel</Text>
                       </TouchableOpacity>
